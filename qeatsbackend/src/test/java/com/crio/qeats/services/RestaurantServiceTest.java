...
class RestaurantServiceTest {
  ...
  private String getServingRadiusDuringNormalHour(List<Restaurant> restaurants, LocalTime timeOfService){
    when(restaurantRepositoryServiceMock
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    assertEquals(getServingRadiusDuringNormalHour(loadRestaurantsDuringNormalHours(), LocalTime.of(18, 0)), "5.0");
   //  assertFalse(false);
  }
